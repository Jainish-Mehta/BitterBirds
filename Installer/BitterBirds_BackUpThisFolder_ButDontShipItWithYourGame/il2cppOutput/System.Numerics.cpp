...
IL_0096:
	...
	}
	{
		...
		int8_t* L_90 = (int8_t*) (L_89 ? alloca(L_89) : NULL);
		memset(L_90, 0, L_89);
		V_18 = (uint32_t*)(L_90);
		int32_t L_91 = V_17;
		...
		int8_t* L_94 = (int8_t*) (L_93 ? alloca(L_93) : NULL);
		memset(L_94, 0, L_93);
		V_19 = (uint32_t*)(L_94);
		uint32_t* L_95 = V_10;
		int32_t L_96 = V_11;
...
IL_0061:
	...
	}
	{
		...
		int8_t* L_83 = (int8_t*) (L_82 ? alloca(L_82) : NULL);
		memset(L_83, 0, L_82);
		V_21 = (uint32_t*)(L_83);
		int32_t L_84 = V_19;
		...
		int8_t* L_91 = (int8_t*) (L_90 ? alloca(L_90) : NULL);
		memset(L_91, 0, L_90);
		V_23 = (uint32_t*)(L_91);
		uint32_t* L_92 = V_8;
		int32_t L_93 = V_9;
...
IL_0253:
	...
	}
	{
		...
		int8_t* L_149 = (int8_t*) (L_148 ? alloca(L_148) : NULL);
...
IL_02de:
	{
		...
		int8_t* L_145 = (int8_t*) (L_144 ? alloca(L_144) : NULL);
